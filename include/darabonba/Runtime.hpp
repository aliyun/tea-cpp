...
public:
  ...
  inline bool getAutoretry() const { DARABONBA_PTR_GET_DEFAULT(autoretry_, false) };
  ...
  inline bool getIgnoreSSL() const { DARABONBA_PTR_GET_DEFAULT(ignoreSSL_, false) };
  ...
  inline int64_t getMaxAttempts() const { DARABONBA_PTR_GET_DEFAULT(maxAttempts_, 0) };
  ...
  inline string getBackoffPolicy() const { DARABONBA_PTR_GET_DEFAULT(backoffPolicy_, "") };
  ...
  inline int64_t getBackoffPeriod() const { DARABONBA_PTR_GET_DEFAULT(backoffPeriod_, 0) };
  ...
  inline int64_t getReadTimeout() const { DARABONBA_PTR_GET_DEFAULT(readTimeout_, 0) };
  ...
  inline int64_t getConnectTimeout() const { DARABONBA_PTR_GET_DEFAULT(connectTimeout_, 0) };
  ...
  inline int64_t getMaxIdleConns() const { DARABONBA_PTR_GET_DEFAULT(maxIdleConns_, 0) };
  ...
  inline string getLocalAddr() const { DARABONBA_PTR_GET_DEFAULT(localAddr_, "") };
  ...
  inline const ExtendsParameters & getExtendsParameters() const { DARABONBA_PTR_GET_CONST(extendsParameters_, ExtendsParameters) };
  inline ExtendsParameters getExtendsParameters() { DARABONBA_PTR_GET(extendsParameters_, ExtendsParameters) };
  ...
  inline const RetryOptions & getRetryOptions() const { DARABONBA_PTR_GET_CONST(retryOptions_, RetryOptions) };
  inline RetryOptions getRetryOptions() { DARABONBA_PTR_GET(retryOptions_, RetryOptions) };
