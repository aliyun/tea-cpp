...
public:
  ...
  inline const map<string, string> &getHeaders() const {
    DARABONBA_PTR_GET_CONST(headers_, map<string, string>)
  };
  inline map<string, string> getHeaders() {
    DARABONBA_PTR_GET(headers_, map<string, string>)
  };
  inline ExtendsParameters &setHeaders(const map<string, string> &headers) {
    DARABONBA_PTR_SET_VALUE(headers_, headers)
  };
  inline ExtendsParameters &setHeaders(map<string, string> &&headers) {
  ...
  inline const map<string, string> &getQueries() const {
    DARABONBA_PTR_GET_CONST(queries_, map<string, string>)
  };
  inline map<string, string> getQueries() {
    DARABONBA_PTR_GET(queries_, map<string, string>)
  };
  inline ExtendsParameters &setQueries(const map<string, string> &queries) {
    DARABONBA_PTR_SET_VALUE(queries_, queries)
  };
  inline ExtendsParameters &setQueries(map<string, string> &&queries) {
...
public:
  ...
  inline bool getAutoretry() const {
    DARABONBA_PTR_GET_DEFAULT(autoretry_, false)
  };
  inline RuntimeOptions &setAutoretry(bool autoretry) {
  ...
  inline bool getIgnoreSSL() const {
    DARABONBA_PTR_GET_DEFAULT(ignoreSSL_, false)
  };
  inline RuntimeOptions &setIgnoreSSL(bool ignoreSSL) {
  ...
  inline RuntimeOptions &setKey(string key) {
  ...
  inline RuntimeOptions &setCert(string cert) {
  ...
  inline int64_t getMaxAttempts() const {
    DARABONBA_PTR_GET_DEFAULT(maxAttempts_, 0)
  };
  inline RuntimeOptions &setMaxAttempts(int64_t maxAttempts) {
  ...
  inline string getBackoffPolicy() const {
    DARABONBA_PTR_GET_DEFAULT(backoffPolicy_, "")
  };
  inline RuntimeOptions &setBackoffPolicy(string backoffPolicy) {
  ...
  inline int64_t getBackoffPeriod() const {
    DARABONBA_PTR_GET_DEFAULT(backoffPeriod_, 0)
  };
  inline RuntimeOptions &setBackoffPeriod(int64_t backoffPeriod) {
  ...
  inline int64_t getReadTimeout() const {
    DARABONBA_PTR_GET_DEFAULT(readTimeout_, 0)
  };
  inline RuntimeOptions &setReadTimeout(int64_t readTimeout) {
  ...
  inline RuntimeOptions &setConnectTimeout(int64_t connectTimeout) {
  ...
  inline string getHttpProxy() const {
    DARABONBA_PTR_GET_DEFAULT(httpProxy_, "")
  };
  inline RuntimeOptions &setHttpProxy(string httpProxy) {
  ...
  inline string getHttpsProxy() const {
    DARABONBA_PTR_GET_DEFAULT(httpsProxy_, "")
  };
  inline RuntimeOptions &setHttpsProxy(string httpsProxy) {
  ...
  inline RuntimeOptions &setNoProxy(string noProxy) {
  ...
  inline string getLocalAddr() const {
    DARABONBA_PTR_GET_DEFAULT(localAddr_, "")
  };
  inline RuntimeOptions &setLocalAddr(string localAddr) {
  ...
  inline string getSocks5Proxy() const {
    DARABONBA_PTR_GET_DEFAULT(socks5Proxy_, "")
  };
  inline RuntimeOptions &setSocks5Proxy(string socks5Proxy) {
  ...
  inline string getSocks5NetWork() const {
    DARABONBA_PTR_GET_DEFAULT(socks5NetWork_, "")
  };
  inline RuntimeOptions &setSocks5NetWork(string socks5NetWork) {
  ...
  inline bool getKeepAlive() const {
    DARABONBA_PTR_GET_DEFAULT(keepAlive_, false)
  };
  inline RuntimeOptions &setKeepAlive(bool keepAlive) {
    DARABONBA_PTR_SET_VALUE(keepAlive_, keepAlive)
  };

  // extendsParameters Field Functions
  bool hasExtendsParameters() const {
    return this->extendsParameters_ != nullptr;
  };
  void deleteExtendsParameters() { this->extendsParameters_ = nullptr; };
  inline const ExtendsParameters &getExtendsParameters() const {
    DARABONBA_PTR_GET_CONST(extendsParameters_, ExtendsParameters)
  };
  inline ExtendsParameters getExtendsParameters() {
    DARABONBA_PTR_GET(extendsParameters_, ExtendsParameters)
  };
  inline RuntimeOptions &
  setExtendsParameters(const ExtendsParameters &extendsParameters) {
    DARABONBA_PTR_SET_VALUE(extendsParameters_, extendsParameters)
  };
  inline RuntimeOptions &
  setExtendsParameters(ExtendsParameters &&extendsParameters) {
    DARABONBA_PTR_SET_RVALUE(extendsParameters_, extendsParameters)
  };
  ...
  inline const RetryOptions &getRetryOptions() const {
    DARABONBA_PTR_GET_CONST(retryOptions_, RetryOptions)
  };
  inline RetryOptions getRetryOptions() {
    DARABONBA_PTR_GET(retryOptions_, RetryOptions)
  };
  inline RuntimeOptions &setRetryOptions(const RetryOptions &retryOptions) {
    DARABONBA_PTR_SET_VALUE(retryOptions_, retryOptions)
  };
