...
public:
  ...
  inline int64_t getStatusCode() const {
    DARABONBA_PTR_GET_DEFAULT(statusCode_, 0)
  };
  inline int64_t getRetryAfter() const {
    DARABONBA_PTR_GET_DEFAULT(retryAfter_, 0)
  };
  inline std::string getCode() const { DARABONBA_PTR_GET_DEFAULT(code_, "") };
  inline std::string getMessage() const {
    DARABONBA_PTR_GET_DEFAULT(message_, "")
  };
  inline std::string getDescription() const {
    DARABONBA_PTR_GET_DEFAULT(description_, "")
  };
  inline std::string getAccessDeniedDetail() const {
    DARABONBA_PTR_GET_DEFAULT(accessDeniedDetail_, "")
  };
